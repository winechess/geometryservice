...
public class LocationsService {
    ...
    public Location create(@RequestBody Location location) {
        ...
        if (location.getPoint() == null || location.getPoint().isEmpty()) throw new IllegalArgumentException("Местоположение не указано.");
    ...
    public Set<Location> findByDeviceId(@PathVariable(name = "deviceId") Long deviceId) {
